...
class Announce extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: HomeBody(data: announceList)
    );
  }
}